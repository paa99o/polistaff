...
class Donation extends Model
{
    ...
    {
        return ['request_date' => 'date', 'limit_amount' => 'decimal:2', 'amount' => 'decimal:2', 'treasurer_verified_at' => 'datetime', 'reviewed_at' => 'datetime'];
    }

    public function user(): BelongsTo { return $this->belongsTo(User::class); }
    public function reviewer(): BelongsTo { return $this->belongsTo(User::class, 'reviewed_by'); }
    public function treasurerVerifier(): BelongsTo { return $this->belongsTo(User::class, 'treasurer_verified_by'); }
