...
class MemberDocumentController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $document = MemberDocument::create(['user_id' => $request->user()->id, 'title' => $data['title'], 'document_type' => $data['document_type'], 'file_path' => $request->file('document')->store('member-documents', 'public')]);
